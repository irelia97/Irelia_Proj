...
void myDES(bitset<SIZE_INPUT>& plaintext, bitset<SIZE_SONKEY> Ki[], 
    bitset<SIZE_INPUT>& ciphertext, bool mode)
{
...
int main()
{
    ...
    string s1 = "0000000100100011010001010110011110001001101010111100110111101111";
    string s2 = "1000010111101000000100110101010000001111000010101011010000000101";
    bitset<SIZE_INPUT>  data(s2); 
    bitset<SIZE_OUTPUT> output;

    myDES(data, Ki, output, false);
    cout << "Final res = " << output << endl;
